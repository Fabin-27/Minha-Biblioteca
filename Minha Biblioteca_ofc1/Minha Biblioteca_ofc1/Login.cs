                    ...
                    using (var command = new SqliteCommand(selectQuery, connection))
                    {
                        ...
                        using (var reader = command.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                MessageBox.Show($"Usuário encontrado: {usuarioEncontrado}, Senha encontrada: {senhaEncontrada}");
        ...
        private void AdicionarDadosDeTeste()
        {
            ...
            try
            {
                using (var connection = new SqliteConnection($"Data Source={dbPath}"))
                {
                    ...
                    {
                        command.Parameters.AddWithValue("@Usuario", "teste_usuario");
                        command.Parameters.AddWithValue("@Senha", "teste_senha");
